...
Spotify Discography Exporter  - Get a full list of every song you have on Spotify — titles, links, and ISRC codes — in one spreadsheet.
...
Which album/single it came from, and the release date.

Think of it as making your own backup/master list of your Spotify catalog.
...
Watch it work — it'll print out each album/single as it goes
